...
function App() {
  ...
  return (
    <div className="flex-1 flex flex-col justify-between min-h-screen w-full">
      {/* Main Content Area */}
      <main className="flex-1 flex flex-col items-center justify-center py-4 w-full px-4">
        {dbError && (
